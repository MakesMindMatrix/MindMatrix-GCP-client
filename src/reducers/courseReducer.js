import { ALL_COURSES_FAIL, ALL_COURSES_REQUEST, ALL_COURSES_SUCCESS, CLEAR_ERRORS, COURSE_DATA_FAIL, COURSE_DATA_REQUEST, COURSE_DATA_SUCCESS, COURSE_LANDING_PAGE_DATA_FAIL, COURSE_LANDING_PAGE_DATA_REQUEST, COURSE_LANDING_PAGE_DATA_SUCCESS, COURSE_PAYMENT_FAIL, COURSE_PAYMENT_REQUEST, COURSE_PAYMENT_STATUS_FAIL, COURSE_PAYMENT_STATUS_REQUEST, COURSE_PAYMENT_STATUS_SUCCESS, COURSE_PAYMENT_SUCCESS, ENROLL_COURSE_FAIL, ENROLL_COURSE_REQUEST, ENROLL_COURSE_SUCCESS, GET_PAYMENT_DATA_FAIL, GET_PAYMENT_DATA_REQUEST, GET_PAYMENT_DATA_SUCCESS, MY_COURSES_FAIL, MY_COURSES_REQUEST, MY_COURSES_SUCCESS, PAYMENT_DATA_FAIL, PAYMENT_DATA_REQUEST, PAYMENT_DATA_SUCCESS, SSO_LOGIN_FAIL, SSO_LOGIN_REQUEST, SSO_LOGIN_SUCCESS, USER_REPORT_FAIL, USER_REPORT_REQUEST, USER_REPORT_SUCCESS } from '../constants/courseConstant'
...
export const courseLandingPadeDataReducer = (state = {}, action) => {
    switch (action.type) {
        case COURSE_LANDING_PAGE_DATA_REQUEST:
            return {
                ...state,
                loading: true
            }

        case COURSE_LANDING_PAGE_DATA_SUCCESS:
            return {
                ...state,
                loading: false,
        ...
        case COURSE_LANDING_PAGE_DATA_FAIL:
            return {
                ...state,
                loading: false,
                error: action.payload
