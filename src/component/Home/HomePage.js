      ...
      <div className="homePage_container">
        ...
        <div className="hero_section">
          <div className="heroLeft">
            <h1>
              <span className="headingColor">Your career companion</span> from
        ...
        <div className="learning_pathway_section">
          <h1>
            <span className="headingColor">
              Industry driven Learning Pathways
            </span>
        ...
        <div className="learning_section">
          <h1>
            Our learning philosophy for <br />
            <span
              style={{
                fontStyle: "italic",
                fontWeight: "400",
          ...
          <div className="learning_section_card_container">
            {LearningPhilosophyData.map((elm, index) => {
              return (
                <div className="learning_section_card" key={index}>
        ...
        <div className="curriculum_section">
          <h1 style={{ fontSize: "4.8rem" }}>
            <span className="headingColor">Certified & Curriculum</span> aligned
          </h1>
          <div>
        ...
        <div className="career_companion_section">
          <h1>
            More than just static courses,
            <br />
            <span className="headingColor">A career companion</span>
          </h1>
          ...
          <div className="career_companion_card_box">
            <div className="career_companion_card_one">
              <div className="companion_card_one_left">
                ...
                <p>
                  Our courses fit perfectly with your school or college
                  timetable, so you can learn without any extra hassle
                </p>
            ...
            <div style={{ display: "flex" }}>
              <div className="career_companion_card_two">
                <div className="companion_card_two_top">
                  ...
                  <p>
                    Identify what you’re missing with personalized evaluations
                    starting from your first year.
                  </p>
                </div>
              ...
              <div className="career_companion_card_three">
                <div className="companion_card_three_top">
                  ...
                  <p>
                    Learn with Google-certified programs and courses co-created
            ...
            <div style={{ display: "flex" }}>
              <div className="career_companion_card_four">
                ...
                <div className="companion_card_four_bottom">
                  ...
                  <p>
                    Courses customized to your academic progress and career
                    goals.
                  </p>
                </div>
              </div>
              ...
              <div className="career_companion_card_five">
                <div className="companion_card_five_top">
                  ...
                  <p>
                    From skill-building to resume optimization, we’re with you
                    at every st
                  </p>
                </div>
        ...
        <div className="start_journey_section">
          <div className="start_journey_box">
            <h1>
              Ready to{" "}
              <span className="headingColor">
                start your journey with MindMatrix?
              </span>
            </h1>
            <div>
        ...
        <div className="footer_section">
          ...
          <div className="footer_child">
            ...
            <ul>
              ...
              <li>
                <Link to="/cancellations-return-policy">
...
const LearningPhilosophyCard = ({ data }) => {
  ...
  return (
    <>
      <div
        className="learning_philosophy_card_container"
        style={
          bg_image
            ? { backgroundImage: `url(${bg_image})`, padding: "2rem" }
            : null
        }
      >
        {icon ? (
          <div style={{ display: "flex" }}>
            ...
            <div
              className="learning_philosophy_card_icon"
    ...
    <>
      <div className="learningPathwayCard_container">
        ...
        <button
          ...
          className="btnOne homeProgramBtn"
        >
  ...
  return (
    <>
      <div className="industryCard_container">
        <div
          className="industryCard_container_image"
  ...
  return (
    <>
      <div className="LearnerCard_container">
        <div
          className="learningCard_container_image"
          style={{ backgroundImage: `url('${image}')` }}
        ></div>
        <h1>{para}</h1>
      </div>
...
export const LearningPhilosophyData = [
  ...
  },
  {
    ...
    bg_image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1747484826/SKILL_ihxife.png",
  },
  {
    heading: "Ability",
    ...
    bg_image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1747484827/abilitY_x0b0zi.png",
  },
  {
    heading: "Behaviour",
    para: "Master teamwork, communication, and adaptability.",
    bg_image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1747050526/Info_Block_duin4k.png",
  },
];
...
export const LearningPathwayData = [
  {
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1746525803/learningPathway3_czwbkj.png",
    courseCode: "Gen AI",
  ...
  {
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1746525803/learningPathway2_yf0now.png",
    courseCode: "IoT",
  ...
  {
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1746525803/learningPathway1_dck8hd.png",
  ...
  {
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1747486476/startup-employee-looking-business-charts-using-ai-software_qcqars.jpg",
    courseCode: "Programming",
...
export const QuickQuizData = [
  {
    heading: "Register",
    subHeading:
      "Start your personalised journeny with your interests, skills, and career goals.",
    icon: <FaQuestion />,
  },
  {
    heading: "Get Personalised Learning Recommendations",
    subHeading:
      "Based on your quiz results, we’ll suggest courses tailored just for you. Choose the best fit for your learning journey.",
    icon: <HiLightBulb />,
  },
  {
    heading: "Track progress and earn certificates",
    subHeading:
      "Track your progress & achievements. Collect certificates to show your achievements.",
    icon: <FaMedal />,
  },
];
...
export const CertifiedData = [
  {
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1747486152/Bangalore_Institute_of_Technology_logo_phtkun.png",
    heading: "Bangalore institute of technology, Bangalore",
  },
  {
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1746437752/srideviLogo_f36wmv.png",
    heading: "Shridevi Institute of Technology",
  },
  {
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1746437752/mysuruLogo_ixzztm.png",
    heading: "Mysuru Royal Institute of Technology",
  },
  {
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1746437752/sriSiddarthaLogo_emhwnl.png",
...
export const LearningData = [
  {
    ...
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1747461170/learner_1_apozgx.png",
  },
  {
    para: "Hands-on experiences with real tools",
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1747462732/learner2_t2tsuu.png",
  },
  {
    para: "Comprehensive career-readiness beyond academics",
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1747462768/learner3_sci9uz.png",
  },
];
...
export const IndustryData = [
  {
    ...
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1747461155/industry1_mhec7y.png",
  },
  {
    para: "Precision hiring of future-ready talent",
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1747461155/industry2_ftxw9s.png",
  },
  {
    para: "Simplified, smart recruitment process",
    image:
      "https://res.cloudinary.com/djsg8kbaz/image/upload/v1747458674/industry3_orul2e.png",
  },
];
